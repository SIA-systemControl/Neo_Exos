...
#define encoder_12bits   4096.0

#define transmission_hip 100.0
...
inline double pos_inc2deg_12bits(int inc){
    return (inc * 360.0 / encoder_12bits);
}

inline double pos_inc2rad_12bits(int inc){
    return (inc * 2.0 * Pi / encoder_12bits);
}

inline int pos_deg2inc_12bits(double deg){
    return (int)(deg * encoder_12bits / 360.0);
}

inline int pos_rad2inc_12bits(double rad){
    return (int)(rad * encoder_12bits / (2 * Pi));
}
